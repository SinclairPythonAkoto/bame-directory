...
@app.route("/Arts-Media-Tech-Category")
def artsCategory():
    ...
    return render_template('artCat.html', art_category=art_category, artCat=artCat)
...
def search():
    if request.method == 'POST':
        ...
        if selectCategory == "arts":
            ...
            for x in s: # for each keyword selected..
                ...
                # if the search keyword matches with the entry keyword then release data
                    if search[x] in artCat[y]['keyWords']:
                        ...
                        error =  "Sorry couldn't find what you were looking for! Please try again."
                        # return error

                        return render_template('new.html', error=error)
        elif selectCategory == "charites":
            ...
            # error =  "Sorry couldn't find what you were looking for! Please try again."
            return render_template('new.html')
            # return "Sorry couldn't find what you were looking for! Please try again."
